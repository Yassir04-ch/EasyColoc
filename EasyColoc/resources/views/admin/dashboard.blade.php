...
<aside class="hidden md:flex flex-col w-64 min-h-screen bg-[#141414] border-r border-white/5 px-4 py-6 fixed left-0 top-0 bottom-0 z-40">
  ...
  <nav class="flex flex-col gap-1 flex-1">
    ...
    <a href="#users" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#888] hover:text-white hover:bg-white/5 text-sm no-underline transition-all">
      <span>👥</span> Utilisateurs
    </a>
    <a href="#colocations" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#888] hover:text-white hover:bg-white/5 text-sm no-underline transition-all">
      <span>🏠</span> Colocations
    </a>
    <a href="#depenses" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#888] hover:text-white hover:bg-white/5 text-sm no-underline transition-all">
      <span>💸</span> Dépenses
    </a>

    <p class="text-[#333] text-xs font-semibold uppercase tracking-widest px-3 mb-2 mt-4">Modération</p>
    <a href="#banned" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#888] hover:text-white hover:bg-white/5 text-sm no-underline transition-all">
      <span>🚫</span> Utilisateurs bannis
    </a>
  </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div id="users" class="bg-[#141414] border border-white/5 rounded-2xl p-6">
        <div class="flex items-center justify-between mb-5">
          <h2 class="font-bold text-base flex items-center gap-2">👥 Derniers utilisateurs</h2>
          <span class="text-xs text-[#00e5a0] hover:underline cursor-pointer">Voir tout</span>
        </div>
